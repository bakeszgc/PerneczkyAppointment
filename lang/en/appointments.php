...
return [
    ...
    "introduce_p1" => "We are almost done! But first we need a couple information from you to know who are we going to give a fresh look to.",
    "introduce_p2" => "If you want to book without an account, you can do this by filling in the fields below. However, our registered guests or those who log in with a Facebook or Google account can access benefits and features such as modifying appointments, one-click rebooking and discounts on the service price. Believe us, it's worth it",
    ...
    "upcoming" => "Upcoming",
    "previous" => "Previous",
    "first_time" => "Haven't you visited us yet?",
    "first_time_book" => "Book your first appointment now!",
    "no_upcoming" => "You don't have any upcoming appointments",
    "no_previous" => "You don't have any previous appointments",
    "why_not_book" => "Why not booking a new one right now?",
    "cancelled" => "Cancelled",
    "deleted" => "(deleted)",
    "today" => "Today",
    "tomorrow" => "Tomorrow",
