...
"px - 3px);" }}">
    ...
    <a href="{{ route('appointments.show',$appointment) }}">
        <div @class([
            'bg-blue-100 hover:bg-blue-200 border border-blue-300 transition-all text-blue-600 h-full m-0.5 px-1 rounded-md max-lg:translate-y-6 overflow-hidden' => true,
