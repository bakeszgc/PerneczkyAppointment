<a href="{{$link}}" title="{{ $title }}" @class([
    ...
    'bg-[#0018d5] hover:bg-[#0f0f0f] text-white' => $role == 'createMain' || $role === 'ctaMain' || $role == 'backMain',
    ...
    'bg-green-50 hover:bg-green-200 border-green-300 text-green-700' => $role === 'timeoffCreate',
