<x-user-layout currentView="admin" :title="$barber->getName() . ' - '">
    ...
    <x-show-card :show="true" type="bookings" class="mb-4">
        <div class="grid grid-cols-3 *:flex *:flex-col *:items-center mb-8">
            <div>
                ...
                <p class="text-lg">{{ $numberOfBookings['upcoming'] }}</p>
            </div>
            ...
            <div class=" border-x-2">
                ...
                <h2 class="text-xl font-bold">Previous</h2>
                <p class="text-lg">{{ $numberOfBookings['previous'] }}</p>
            </div>
            ...
            <div>
                ...
                <h2 class="text-xl font-bold">Cancelled</h2>
                <p class="text-lg">{{ $numberOfBookings['cancelled'] }}</p>
            </div>
        </div>

        <div>
            <x-link-button link="" :full="true">All bookings</x-link-button>
        </div>
    </x-show-card>
</x-user-layout>