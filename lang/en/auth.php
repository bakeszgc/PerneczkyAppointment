...
return [
    ...
    */
    ...
    "sign_in_social" => "Log in using social media accounts",
    ...
    "john" => "John",
    "example" => "Example",
    "read_and_accept" => "I have read and I accept the",
    ...
    "pw_checklist" => "Password criteria checklist",
    "contains_at_least_one" => "contains at least one",
    "lc_letter" => "lowercase letter",
    "uc_letter" => "uppercase letter",
    "number" => "number",
    "8_char_long" => "8 characters long",
    "at least" => "at least",
