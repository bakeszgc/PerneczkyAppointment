        ...
        <h2 class="text-xl max-md:text-lg font-bold flex gap-2 items-center">
            @switch($type)
                @case('password')
                    ...
                    <span>{{ __('users.change_your_pw') }}</span>
                @break
                ...
                @case('picture')
                    ...
                    <span>{{ __('users.profile_picture') }}</span>
                @break
                ...
                @case('destroy')
                    ...
                    <span>{{ __('admin.delete_this_account') }}</span>
                @break
                ...
                @case('barbers')
                    ...
                    <span>{{ __('admin.manage_barbers') }}</span>
                @break
                ...
                @case('services')
                    ...
                    <span>{{ __('admin.manage_services') }}</span>
                @break
                ...
                @case('bookings')
                    ...
                    <span>{{ __('admin.manage_bookings') }}</span>
                @break
                ...
                @case('customers')
                    ...
                    <span>{{ __('admin.manage_customers') }}</span>
                @break
                ...
                @case('restore')
                    ...
                    <span>{{ __('admin.restore_this_account') }}</span>
                @break
                ...
                @case('timeoff')
                    ...
                    <span>{{ __('admin.manage_timeoffs') }}</span>
                @break
                ...
                @case('calendar')
                    ...
                    <span>{{ __('admin.overview_of_bookings') }}</span>
                @break
                ...
                @case('mailing')
                    ...
                    <span>{{ __('users.mailing_pref') }}</span>
                @break
            @endswitch
        </h2>
