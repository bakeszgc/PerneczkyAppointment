...
return [
    ...
    "introduce_p1" => "Majdnem meg is vagyunk! Mindenek előtt meg kell adnod magadról pár adatot, hogy tudjuk kinek fogunk friss külsőt varázsolni.",
    "introduce_p2" => "Ezt megteheted az alábbi mezők kitöltésével, ha fiók nélkül szeretnél foglalni. Azonban a regisztrált, illetve Facebook vagy Google fiókkal belépett vendégeink olyan előnyökhöz és funkciókhoz férhetnek hozzán, mint a foglalás módosítása, egy kattintásos újrafoglalás, illetve kedvezmények a szolgáltatás árából. Hidd el, megéri",
    ...
    "upcoming" => "Következő",
    "previous" => "Korábbi",
    "first_time" => "Még nem jártál nálunk?",
    "first_time_book" => "Foglald le most az első időpontod!",
    "no_upcoming" => "Nincs még következő időpontod",
    "no_previous" => "Nincsenek még korábbi időpontjaid",
    "why_not_book" => "Foglalj egy újat most!",
    "cancelled" => "Lemondott",
    "deleted" => "(törölt)",
    "today" => "Ma",
    "tomorrow" => "Holnap",
