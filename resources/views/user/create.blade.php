        ...
        <form action="{{route('user.store')}}" method="POST">
            ...
            <div class=" mb-4 grid grid-cols-2 max-md:grid-cols-1 gap-4">
                <div>
                    ...
                    <x-input-field name="first_name" id="first_name" value="{{old('first_name') ?? request('first_name')}}" placeholder="John" autoComplete="on" class="w-full regInput reqInput"/>
                    @error('first_name')
                ...
                <div>
                    ...
                    <x-input-field name="last_name" id="last_name" autoComplete="on" value="{{old('last_name')}}" placeholder="Example" class="w-full regInput reqInput"/>
                    @error('last_name')
                        <p class=" text-red-500">{{$message}}</p>
                    @enderror
                </div>
            ...
            <div class="mb-4">
                ...
                <x-input-field type="email" name="email" id="email" autoComplete="on" value="{{old('email') ?? request('email')}}" placeholder="john@example.com" class="w-full regInput reqInput"/>
                @error('email')
                    <p class=" text-red-500">{{$message}}</p>
                @enderror
            </div>
