<div>
    ...
    <script>
        ...
        function renderBarberNames(colHeaderContainer, barbers) {
        ...
        function renderDateNumbersNew(colHeaderContainer,date) {
            colHeaderContainer.innerHTML = "";
        ...
        function toggleFullWidth(element, barbers) {
            widthClass = "w-[" + ((barbers.length + 1) * 100 / 8) + "%]";
