            ...
            <div>
                <p class="text-sm text-gray-700 leading-5 dark:text-gray-400">
                    ...
                    @if ($paginator->firstItem())
                        <span class="font-medium">{{ $paginator->firstItem() . Appointment::getFromSuffix($paginator->firstItem()) }}</span>
                        <span class="font-medium">{{ __('pagination.to1') . $paginator->lastItem() . __('pagination.to2') }}</span>
                    @else
                        {{ $paginator->count() }}
                    @endif
                    {!! __('pagination.of') !!}
